# This scripts creates test patients

# Addresses
addresses <- tibble::tribble(
  ~patient_id, ~address_id,  ~start_date,    ~end_date, ~address_type, ~rural_urban_classification, ~imd_rounded,  ~msoa_code, ~has_postcode, ~care_home_is_potential_match, ~care_home_requires_nursing, ~care_home_does_not_require_nursing, # nolint
            1,           1, "1900-01-01",           NA,             1,                           1,        32400, "E02000010",           "T",                           "T",                         "F",                                 "T", # nolint
            2,           1, "1950-01-01",           NA,             1,                           1,        22400, "E02000011",           "T",                           "F",                          NA,                                  NA, # nolint
            3,           1, "1960-01-01", "2020-01-01",             1,                           1,        12400, "E02000012",           "T",                           "F",                          NA,                                  NA, # nolint
            3,           1, "2020-01-02",           NA,             1,                           1,        12400, "E02000013",           "T",                           "T",                         "F",                                 "T", # nolint
            4,           1, "1970-01-01",           NA,             1,                           1,         2400, "E02000013",           "T",                           "F",                          NA,                                  NA, # nolint
            5,           1, "1980-01-01",           NA,             1,                           1,          400, "E02000014",           "T",                           "F",                          NA,                                  NA, # nolint
            6,           1, "1990-01-01",           NA,             1,                           1,         1400, "E02000014",           "T",                           "F",                          NA,                                  NA, # nolint
            7,           1, "2000-01-01",           NA,             1,                           1,         2400, "E02000015",           "T",                           "F",                          NA,                                  NA, # nolint
            8,           1, "2000-01-01",           NA,             1,                           1,         3400, "E02000015",           "T",                           "F",                          NA,                                  NA, # nolint
            9,           1, "2021-01-01",           NA,             1,                           1,         4400, "E02000015",           "T",                           "F",                          NA,                                  NA  #nolint
  )
...
practice_registrations <- tibble::tribble(
  ~patient_id,  ~start_date,    ~end_date, ~practice_pseudo_id, ~practice_stp, ~practice_nuts1_region_name, # nolint
            1, "2018-01-01",           NA,                   1,             1,          "region_practice1", # nolint
            2, "2010-01-01", "2012-01-01",                   1,             1,          "region_practice1", # nolint
            2, "2012-02-01", "2018-01-01",                   2,             1,          "region_practice2", # nolint
            2, "2018-01-02",           NA,                   3,             1,          "region_practice3", # nolint
            3, "2000-01-01", "2019-01-01",                   2,             2,          "region_practice2", # nolint
            3, "2019-02-01", "2023-01-01",                   3,             2,          "region_practice3", # nolint
            3, "2023-01-02",           NA,                   4,             2,          "region_practice4", # nolint
            4, "2018-01-01",           NA,                   2,             2,          "region_practice2", # nolint
            5, "2018-01-01",           NA,                   2,             2,          "region_practice2", # nolint
            6, "2018-01-01",           NA,                   3,             3,          "region_practice3", # nolint
            7, "2018-01-01",           NA,                   3,             3,          "region_practice3", # nolint
            8, "2018-01-01",           NA,                   3,             3,          "region_practice3", # nolint
            9, "2018-01-01",           NA,                   3,             3,          "region_practice3", # nolint
           10, "2018-01-01",           NA,                   3,             3,          "region_practice3" # nolint
  )
